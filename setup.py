...
setup(
    name='''ynabintegrationscli''',
    version=version,
    description='''A tool to  upload transactions from an abn amro account and credit card to ynab provided a configuration file and valid session cookies for an abn amro connection''',
    long_description=readme + '\n\n' + history,
    author='''Costas Tyfoxylos''',
    author_email='''costas.tyf@gmail.com''',
    url='''https://github.com/costastf/ynabintegrationscli''',
    packages=find_packages(where='.', exclude=('tests', 'hooks', '_CI*')),
    package_dir={'''ynabintegrationscli''':
                 '''ynabintegrationscli'''},
    include_package_data=True,
    install_requires=requirements,
    license='MIT',
    zip_safe=False,
    keywords='''ynabintegrationscli ''',
    entry_points = {
                   'console_scripts': [
